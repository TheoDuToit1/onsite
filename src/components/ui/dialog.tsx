...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content ref={ref} className={cn('fixed z-50 grid w-full max-w-lg gap-4 rounded-2xl border bg-white p-6 shadow-soft top-[50%] left-1/2 -translate-x-1/2 -translate-y-1/2', className)} {...props}>
      {children}
